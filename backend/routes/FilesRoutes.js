...
route.post("/editTask", async (req, res) => {
  const { projectId, taskId, updatedTask } = req.body;
  ...
  try {
    ...
    task.TotalNumber = updatedTask.TotalNumber;
...
route.post("/addSolutions", async (req, res) => {
  const { projectId, taskId, solutions, Attachment } = req.body;
