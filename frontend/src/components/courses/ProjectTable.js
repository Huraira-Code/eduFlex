      ...
      <Table className={classes.table} aria-label="custom pagination table">
        <TableHead>
          <TableRow>
            ...
            {studentActions && <TableCell>Actions</TableCell>}
          </TableRow>
        </TableHead>
        {loading ? (
              ...
              <>
                {(rowsPerPage > 0
                  ...
                  <TableRow>
                    ...
                    <TableCell align="left">{row?.projectDetail}</TableCell>
                    ...
                    {studentActions && (
                      <TableCell align="left">
                        {row.senderID !== user && (
                          <div className="d-flex align-items-center">
                            <IconButton onClick={() => handleShowStudentDetails(row)}>
                              <DeleteOutlineIcon />
                            </IconButton>
                          </div>
                        )}
