...
import AddLectureForm from "../../AdminComponents/academics/notes/LectureForm";
...
function AddLecture() {
  ...
  const handleAddNote = async () => {
    ...
    try {
      ...
      console.log("dataUrl:", dataUrl); // 👈 You can now see the base64 string
      ...
      let data = await axios.post("/upload", { dataUrl: dataUrl }, {});
      if (data.error) {
